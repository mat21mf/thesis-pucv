...
/* function prototypes */
void resample(char*,char*);

int main() {
  char* panfname = "../previos/Clas_geo_clip.tif" ;
  char* NIRfname = "../../DriveBiotopos/Daniel_Zamorano/Pixel25Norm/Transf_carbono_2013_px25.tif" ;
  resample(NIRfname,panfname);
  return 0;
}
...
void resample(
  ...
  "../../DriveBiotopos/Daniel_Zamorano/Pixel25Resm/Transf_carbono_2013_px25__resampled.tif" ,
  dstncols, dstnrows , 1 ,
  sourceDatatype, NULL);
  ...
  eErr = GDALReprojectImage( srcDataset ,
    ...
    outDataset ,
    dstProjection ,
  GRA_NearestNeighbour, 0.0, 0.0, NULL,NULL,NULL);
